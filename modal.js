...
const firstNameVerification = () => {
  if (
    ...
    console.log(
      "Le champ prénom ne peut être vide et doit contenir au moins 2 lettres."
    );
...
const lastNameVerification = () => {
  if (
    ...
    console.log(
      "Le champ nom ne peut être vide et doit contenir au moins 2 lettres."
    );
...
const emailVerification = () => {
  if (
    email.value == null ||
    email.value == "" ||
    email.value.match(regexEmail) == false
  ) {
    ...
    email
      ...
      .setAttribute(
        "data-error",
        "Veuillez entrer un email valide (ex : johndoe@gmail.com)."
      );
    email.value = "";
...
const birthDateVerification = () => {
  ...
  if (
    ...
    birthDate.parentElement.setAttribute(
      "data-error",
      "Veuillez devez avoir au minimum 18ans pour vous inscrire."
    );
    birthDate.value = "";
...
const tournamentQttVerification = () => {
  if (
    tournamentQtt.value == null ||
    tournamentQtt.value == "" ||
    isNaN(tournamentQtt.value) == true ||
    tournamentQtt.value < 0
  ) {
    ...
    tournamentQtt
      ...
      .setAttribute(
        "data-error",
        "Veuillez renseigner le nombre de tournois auxquels vous avez participé."
      );
    tournamentQtt.value = "";
...
const radioBtnVerification = () => {
  if (city == null || city == undefined) {
    ...
    location1
      .closest(".formData")
      .setAttribute("data-error", "Veuillez sélectionner une ville.");
...
const termsOfUseVerification = () => {
  if (
    ...
    termsOfUse.checked == undefined ||
    termsOfUse.checked == null
  ) {
...
function validate() {
  ...
  if (
    ...
    tournamentQttVerification() &&
    getLocation() &&
    radioBtnVerification() &&
    termsOfUseVerification()
  ) {
    birthDate.value;
    formData = {
